...
class ProposalResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Toggle::make('properties.use_client_agreement')->label('Use Client Agreement?'),
            Forms\Components\Placeholder::make('client_agreement')->content(fn($get) => $get('client_agreement') ? 'Yes' : 'No'),
            Forms\Components\Placeholder::make('client_signature')->content(fn($get) => (string) $get('client_signature')),
            Forms\Components\Placeholder::make('client_sign_date')->content(fn($get) => (string) $get('client_sign_date')),
