...
class ProjectEditScreen extends Screen
{
    ...
    public function layout(): iterable
    {
        return [
            Layout::rows([
                ...
                Input::make('project.scope')->title('Scope')->placeholder('Professional'),
                ...
                Input::make('project.external_image_link')
                    ...
                    ->placeholder(
                        'https://www.marketplacer.com/wp-content/uploads/2023/02/Marketplacer_Logo_black.png',
                    ),
    ...
    public function createOrUpdate(Request $request)
    {
        ...
        $project->fill($record)->reorderPositions()->save();
