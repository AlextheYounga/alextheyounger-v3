        ...
        return [
            Layout::legend('user', [
                ...
                Sight::make('Simple Text')->render(
                    fn() => 'This is a wider card with supporting text below as a natural lead-in to additional content.',
                ),
                Sight::make('Action')->render(
                    fn() => Button::make('Show toast')->type(Color::BASIC)->method('showToast'),
                ),
            ])->title('User'),
        ];
    }
