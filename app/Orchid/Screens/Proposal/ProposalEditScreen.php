    ...
    public function layout(): iterable
    {
        ...
        return [
            Layout::rows([
                ...
                Input::make('proposal.title')->title('Title')->required(),
                ...
                Matrix::make('proposal.payment_schedule')
                    ...
                    ->fields([
                        'milestone' => Input::make('milestone')->type('text'),
                        'description' => Input::make('description')->type('text'),
