...
class UserListLayout extends Table
{
    ...
    public function columns(): array
    {
        return [
            ...
            TD::make('email', __('Email'))->sort()->cantHide()->filter(Input::make())->render(
                fn(User $user) => ModalToggle::make($user->email)
            ...
            TD::make(__('Actions'))->align(TD::ALIGN_CENTER)->width('100px')->render(
